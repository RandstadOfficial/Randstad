...
AddEventHandler('police:client:spawnCone', function()
    RSCore.Functions.Progressbar("spawn_object", "Object plaatsen..", 2500, false, true, {
...
AddEventHandler('police:client:deleteObject', function()
    ...
    if dist < 5.0 then
        RSCore.Functions.Progressbar("remove_object", "Object verwijderen..", 2500, false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true,
