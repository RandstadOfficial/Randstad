...
RegisterNetEvent('rs-shops:client:UpdateShop')
AddEventHandler('rs-shops:client:UpdateShop', function(shop, itemData, amount)
    TriggerServerEvent('rs-shops:server:UpdateShopItems', shop, itemData, amount)
end)

RegisterNetEvent('rs-shops:client:SetShopItems')
AddEventHandler('rs-shops:client:SetShopItems', function(shop, shopProducts)
    Config.Locations[shop]["products"] = shopProducts
end)

RegisterNetEvent('rs-shops:client:RestockShopItems')
AddEventHandler('rs-shops:client:RestockShopItems', function(shop, amount)
...
Citizen.CreateThread(function()
    for store,_ in pairs(Config.Locations) do
        ...
        elseif Config.Locations[store]["products"] == Config.Products["rental"] then
