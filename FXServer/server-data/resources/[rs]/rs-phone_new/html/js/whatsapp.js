...
$(document).on('click', '.whatsapp-chat', function(e){
    ...
    $.post('http://rs-phone_new/ClearAlerts', JSON.stringify({
...
RS.Phone.Functions.GetLastMessage = function(message) {
...
$(document).on('click', '#whatsapp-openedchat-send', function(e){
    ...
    if (Message !== null && Message !== undefined && Message !== "") {
        $.post('http://rs-phone_new/SendMessage', JSON.stringify({
...
$(document).on('click', '.whatsapp-shared-location', function(e){
    ...
    $.post('http://rs-phone_new/SharedLocation', JSON.stringify({
