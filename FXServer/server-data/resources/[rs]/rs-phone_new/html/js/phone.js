...
$(document).on('click', '.phone-app-footer-button', function(e){
    ...
    if (PressedFooterTab !== CurrentFooterTab) {
        ...
        if (PressedFooterTab == "recent") {
            $.post('http://rs-phone_new/ClearRecentAlerts');
        }
...
$(document).on('click', '.phone-recent-call', function(e){
    ...
    $.post('http://rs-phone_new/CallContact', JSON.stringify({
        ContactData: cData
    }), function(status){
...
$(document).on('click', '#new-chat-phone', function(e){
    ...
    $.post('http://rs-phone_new/GetWhatsappChat', JSON.stringify({phone: ContactData.number}), function(chat){
...
$(document).on('click', '#edit-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        $.post('http://rs-phone_new/EditContact', JSON.stringify({
...
$(document).on('click', '#add-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        $.post('http://rs-phone_new/AddNewContact', JSON.stringify({
        ...
        RS.Phone.Notifications.Add("fas fa-exclamation-circle", "Contact Toevoegen", "Vul alle velden in!");
    }
});
...
$(document).on('click', '#outgoing-cancel', function(e){
    ...
    $.post('http://rs-phone_new/CancelOutgoingCall');
});

$(document).on('click', '#incoming-deny', function(e){
    e.preventDefault();

    $.post('http://rs-phone_new/DenyIncomingCall');
});

$(document).on('click', '#ongoing-cancel', function(e){
    e.preventDefault();
    
    $.post('http://rs-phone_new/CancelOngoingCall');
});
...
$(document).on('click', '#incoming-answer', function(e){
    ...
    $.post('http://rs-phone_new/AnswerCall');
});
