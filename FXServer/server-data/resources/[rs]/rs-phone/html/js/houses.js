    ...
    if (CurrentHouseData.keyholders !== undefined && CurrentHouseData.keyholders !== null) {
        $.each(CurrentHouseData.keyholders, function(i, keyholder){
            if (keyholder !== null && keyholder !== undefined) {
                var elem;
                if (keyholder.charinfo.firstname !== RS.Phone.Data.PlayerData.charinfo.firstname && keyholder.charinfo.lastname !== RS.Phone.Data.PlayerData.charinfo.lastname) {
...
$(document).on('click', '.house-key-delete', function(e){
    ...
    $.post('http://rs-phone/RemoveKeyholder', JSON.stringify({
        HolderData: Data,
...
$(document).on('click', '#myhouse-option-transfer-confirm', function(e){
    ...
    $.post('http://rs-phone/TransferCid', JSON.stringify({
        newBsn: NewBSN,
        HouseData: CurrentHouseData,
        ...
        if (CanTransfer) {
            ...
            RS.Phone.Notifications.Add("fas fa-home", "Huizen", "Dit is een ongeldig BSN-nummer", "#27ae60", 2500);
