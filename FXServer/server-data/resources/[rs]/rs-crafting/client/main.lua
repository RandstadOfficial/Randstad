...
function ItemsToItemInfo()
	itemInfos = {
		...
		[13] = {costs = RSCore.Shared.Items["metalscrap"]["label"] .. ": 60x, " ..RSCore.Shared.Items["steel"]["label"] .. ": 70x, "..RSCore.Shared.Items["aluminumoxide"]["label"] .. ": 2x, "..RSCore.Shared.Items["ironoxide"]["label"] .. ": 2x."},
