...
AddEventHandler('rs-phone:client:setupCompanies', function()
    SendNUIMessage({
        task = "setupCompanies",
        companies = exports['rs-companies']:GetCompanies()
    })
end)
...
RegisterNUICallback('removeCompany', function(data)
    TriggerServerEvent("rs-companies:server:removeCompany", data.name)
end)

RegisterNUICallback('quitCompany', function(data)
    TriggerServerEvent("rs-companies:server:quitCompany", data.name)
end)
