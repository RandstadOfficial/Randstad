...
AddEventHandler('RSCore:Client:OnPlayerLoaded', function()
    ...
    RSCore.Functions.TriggerCallback('rs-scoreboard:server:GetConfig', function(config)
...
RegisterNetEvent('rs-scoreboard:client:SetActivityBusy')
AddEventHandler('rs-scoreboard:client:SetActivityBusy', function(activity, busy)
