...
RegisterNetEvent('rs-admin:client:toggleNoclip')
AddEventHandler('rs-admin:client:toggleNoclip', function()
    toggleNoClipMode()
end)
...
Citizen.CreateThread( function()
    ...
    function handleMovement(xVect,yVect)
        if ( IsControlJustPressed( 1, changeSpeedKey ) or IsDisabledControlJustPressed( 1, changeSpeedKey ) ) then
            ...
            RSCore.Functions.Notify("Current speed: ".. speeds[travelSpeed])
