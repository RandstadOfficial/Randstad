...
$(document).on('click', '.save-bindings', function(e){
    ...
    $.post('http://rs-commandbinding/save', JSON.stringify({
        keyData: keyData
    }));
});

sBinding.Open = function(data) {
...
sBinding.Close = function() {
    $(".container").fadeOut(150);
    $.post('http://rs-commandbinding/close');
}